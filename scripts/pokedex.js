...
for (const id in pokedex) {
	...
	if (pokemon.forme === "Mega") {
		nections["Mega-Evolution"][""].push(pokemon.baseSpecies)
	}
	else if (pokemon.forme === "Gmax") {
		nections["Gigantamax"][""].push(pokemon.baseSpecies)
	}
	else if (pokemon.forme === "Alola") {
		nections["Regional: "]["Alolan"].push(pokemon.baseSpecies)
	}
	else if (pokemon.forme === "Galar") {
		nections["Regional: "]["Galarian"].push(pokemon.baseSpecies)
	}
	else if (pokemon.forme === "Hisui") {
		nections["Regional: "]["Hisuian"].push(pokemon.baseSpecies)
	}
	if (pokemon.forme != null) {
		continue;
	}
	for (const type of pokedex[id]["types"]) {
		if (!nections["Type: "][type]) {
			nections["Type: "][type] = [];
		}
		nections["Type: "][type].push(pokemon.name);
	}
	gen = "Nine";
	if (pokemon.num < 152) {
		gen = "One";
	...
	else if (pokemon.num < 495) {
		gen = "Four";
	}
	else if (pokemon.num < 650) {
		gen = "Five";
	}
	else if (pokemon.num < 722) {
		gen = "Six";
	}
	else if (pokemon.num < 810) {
		gen = "Seven";
	}
	else if (pokemon.num < 906) {
		gen = "Eight";
	}
	if (!nections["Generation: "][gen]) {
...
for (const cat in nections) {
	for (const subcat in nections[cat]) {
		if (nections[cat][subcat].length < 4) {
			delete nections[cat][subcat];
			if (nections[cat].length < 1) {
				delete nections[cat];
				break;
			}
		}
...
nections["Starter"] = {};
nections["Starter"][""] = ["Bulbasaur", "Charmander", "Squirtle", "Pikachu", "Chikorita", "Cyndaquil", "Totodile", "Treecko", "Torchic", "Mudkip", "Espeon", "Umbreon", "Eevee", "Turtwig", "Chimchar", "Piplup", "Snivy", "Tepig", "Oshawott", "Chespin", "Fennekin", "Froakie", "Rowlet", "Litten", "Popplio", "Grookey", "Scorbunny", "Sobble", "Sprigatito", "Fuecoco", "Quaxly"];
nections["Legendary"] = {};
nections["Legendary"][""] = ["Articuno", "Zapdos", "Moltres", "Mewtwo", "Raikou", "Entei", "Suicune", "Lugia", "Ho-Oh", "Regirock", "Regice", "Registeel", "Latios", "Latias", "Kyogre", "Groudon", "Rayquaza", "Uxie", "Mesprit", "Azelf", "Dialga", "Palkia", "Giratina", "Heatran", "Regigigas", "Cresselia", "Cobalion", "Terrakion", "Virizion", "Tornadus", "Thundurus", "Landorus", "Reshiram", "Zekrom", "Kyurem", "Xerneas", "Yveltal", "Zygarde", "Type: Null", "Silvally", "Tapu Koko", "Tapu Lele", "Tapu Bulu", "Tapu Fini", "Cosmog", "Cosmoem", "Solgaleo", "Lunala", "Necrozma", "Zacian", "Zamazenta", "Eternatus", "Kubfu", "Urshifu", "Regieleki", "Regidrago", "Calyrex", "Glastrier", "Spectrier", "Enamorus", "Wo-Chien", "Chien-Pao", "Ting-Lu", "Chi-Yu", "Okidogi", "Munkidori", "Fezandipiti", "Ogerpon", "Terapagos"];
nections["Mythical"] = {};
nections["Mythical"][""] = ["Mew", "Celebi", "Jirachi", "Deoxys", "Manaphy", "Phione", "Darkrai", "Shaymin", "Arceus", "Victini", "Keldeo", "Meloetta", "Genesect", "Diancie", "Hoopa", "Volcanion", "Magearna", "Marshadow", "Zeraora", "Meltan", "Melmetal", "Zarude", "Pecharunt"];
nections["Shadow"] = {};
nections["Shadow"][""] = ["Arbok", "Vulpix", "Venomoth", "Dugtrio", "Meowth", "Golduck", "Primeape", "Growlithe", "Poliwrath", "Weepinbell", "Magneton", "Dodrio", "Seel", "Grimer", "Shellder", "Hypno", "Voltorb", "Exeggutor", "Hitmonlee", "Hitmonchan", "Rhydon", "Chansey", "Scyther", "Electabuzz", "Magmar", "Tauros", "Lapras", "Snorlax", "Articuno", "Zapdos", "Moltres", "Dragonite", "Bayleef", "Quilava", "Croconaw", "Furret", "Noctowl", "Spinarak", "Ariados", "Mareep", "Flaaffy", "Sudowoodo", "Skiploom", "Aipom", "Sunflora", "Yanma", "Quagsire", "Murkrow", "Misdreavus", "Pineco", "Forretress", "Dunsparce", "Gligar", "Granbull", "Qwilfish", "Heracross", "Sneasel", "Teddiursa", "Ursaring", "Slugma", "Magcargo", "Swinub", "Piloswine", "Delibird", "Skarmory", "Houndour", "Houndoom", "Houndoom", "Stantler", "Smeargle", "Hitmontop", "Raikou", "Entei", "Suicune", "Tyranitar", "Lugia", "Poochyena", "Seedot", "Ralts", "Shroomish", "Makuhita", "Makuhita", "Nosepass", "Sableye", "Meditite", "Gulpin", "Numel", "Vibrava", "Swablu", "Altaria", "Zangoose", "Banette", "Duskull", "Tropius", "Snorunt", "Salamence", "Metagross"];
nections["Ultra Beast"] = {};
nections["Ultra Beast"][""] = ["Nihilego", "Buzzwole", "Pheromosa", "Xurkitree", "Celesteela", "Kartana", "Guzzlord", "Poipole", "Naganadel", "Stakataka", "Blacephalon"];
nections["Paradox"] = {};
nections["Paradox"][""] = ["Great Tusk", "Scream Tail", "Brute Bonnet", "Flutter Mane", "Slither Wing", "Sandy Shocks", "Roaring Moon", "Koraidon", "Walking Wake", "Gouging Fire", "Raging Bolt", "Iron Treads", "Iron Bundle", "Iron Hands", "Iron Jugulis", "Iron Moth", "Iron Thorns", "Iron Valiant", "Miraidon", "Iron Leaves", "Iron Boulder", "Iron Crown"];
nections["Evolves By: "] = {};
nections["Evolves By: "]["Trade"] = ["Alakazam", "Machamp", "Golem", "Gengar", "Politoed", "Slowking", "Steelix", "Scizor", "Kingdra", "Porygon2", "Porygon-Z", "Huntail", "Gorebyss", "Rhyperior", "Electivire", "Magmortar", "Dusknoir", "Milotic", "Gigalith", "Conkeldurr", "Escavalier", "Accelgor", "Aromatisse", "Slurpuff", "Trevenant", "Gourgeist"];
nections["Evolves By: "]["Fire Stone"] = ["Ninetales", "Arcanine", "Arcanine", "Flareon", "Simisear", "Scovillain"];
nections["Evolves By: "]["Water Stone"] = ["Poliwrath", "Cloyster", "Starmie", "Vaporeon", "Ludicolo", "Simipour"];
nections["Evolves By: "]["Thunder Stone"] = ["Raichu", "Magnezone", "Jolteon", "Probopass", "Eelektross", "Vikavolt", "Bellibolt"];
nections["Evolves By: "]["Leaf Stone"] = ["Vileplume", "Victreebel", "Exeggutor", "Electrode", "Leafeon", "Shiftry", "Simisage"];
nections["Evolves By: "]["Moon Stone"] = ["Nidoqueen", "Nidoking", "Clefable", "Wigglytuff", "Delcatty", "Musharna"];
nections["Evolves By: "]["Sun Stone"] = ["Bellossom", "Sunflora", "Whimsicott", "Lilligant", "Heliolisk"];
nections["Evolves By: "]["Shiny Stone"] = ["Togekiss", "Roserade", "Cinccino", "Florges"];
nections["Evolves By: "]["Dusk Stone"] = ["Honchkrow", "Mismagius", "Chandelure", "Aegislash"];
// nections["Evolves By: "]["Dawn Stone"] = ["Gallade", "Froslass"];
// nections["Evolves By: "]["Ice Stone"] = ["Glaceon", "Crabominable", "Cetitan"];
nections["Evolves By: "]["Location"] = ["Magnezone", "Leafeon", "Glaceon", "Probopass", "Vikavolt", "Crabominable"];
nections["Evolves By: "]["Move-Based"] = ["Lickilicky", "Tangrowth", "Ambipom", "Yanmega", "Mamoswine", "Sudowoodo", "Mr. Mime", "Sylveon", "Tsareena", "Naganadel", "Grapploct", "Overqwil", "Wyrdeer", "Annihilape", "Farigiraf", "Dudunsparce", "Hydrapple"];
nections["Evolves By: "]["Friendship"] = ["Crobat", "Pikachu", "Clefairy", "Jigglypuff", "Togetic", "Espeon", "Umbreon", "Blissey", "Marill", "Roselia", "Lopunny", "Chimecho", "Snorlax", "Lucario", "Swoobat", "Leavanny", "Silvally", "Sylveon", "Frosmoth"];
nections["Evolves By: "]["During Daytime"] = ["Espeon", "Roselia", "Chansey", "Lucario", "Tyrantrum", "Gumshoos", "Lycanroc", "Lurantis", "Alcremie", "Sneasler"];
nections["Evolves By: "]["During Nighttime"] = ["Umbreon", "Gliscor", "Weavile", "Chimecho", "Aurorus", "Lycanroc", "Obstagoon", "Alcremie", "Frosmoth", "Ursaluna", "Houndstone"];
nections["Fossil"] = {};
